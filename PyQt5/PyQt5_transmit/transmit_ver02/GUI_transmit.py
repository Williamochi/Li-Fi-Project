...
class Ui_Transmit(object):
    def setupUi(self, Transmit):
        Transmit.setObjectName("Transmit")
        Transmit.resize(1280, 750)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Transmit.sizePolicy().hasHeightForWidth())
        Transmit.setSizePolicy(sizePolicy)
        self.verticalLayoutWidget = QtWidgets.QWidget(Transmit)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(105, 0, 1071, 48))
        ...
        self.spinBox_Q_2.setProperty("value", 0)
        ...
        self.layoutWidget = QtWidgets.QWidget(Transmit)
        self.layoutWidget.setGeometry(QtCore.QRect(915, 600, 261, 141))
        ...
        self.label_click_pos.setIndent(5)
        ...
        self.label_norm_pos.setIndent(5)
        ...
        self.label_real_pos.setIndent(5)
        self.label_real_pos.setObjectName("label_real_pos")
        self.verticalLayout_pos.addWidget(self.label_real_pos)
        self.layoutWidget1 = QtWidgets.QWidget(Transmit)
        self.layoutWidget1.setGeometry(QtCore.QRect(105, 40, 1071, 41))
        ...
        self.layoutWidget2 = QtWidgets.QWidget(Transmit)
        self.layoutWidget2.setGeometry(QtCore.QRect(105, 600, 811, 141))
        ...
        self.graphicsView_graphicL = QtWidgets.QGraphicsView(Transmit)
        self.graphicsView_graphicL.setGeometry(QtCore.QRect(105, 82, 515, 515))
        self.graphicsView_graphicL.setObjectName("graphicsView_graphicL")
        self.graphicsView_graphicR = QtWidgets.QGraphicsView(Transmit)
        self.graphicsView_graphicR.setGeometry(QtCore.QRect(660, 82, 515, 515))
        self.graphicsView_graphicR.setObjectName("graphicsView_graphicR")

        self.retranslateUi(Transmit)
        QtCore.QMetaObject.connectSlotsByName(Transmit)

    def retranslateUi(self, Transmit):
        _translate = QtCore.QCoreApplication.translate
        Transmit.setWindowTitle(_translate("Transmit", "Transmit"))
        self.pushButton_open.setText(_translate("Transmit", "Open"))
        self.pushButton_DCT.setText(_translate("Transmit", "DCT"))
        self.label.setText(_translate("Transmit", "<html><head/><body><p align=\"center\">/dev/ttyUSB</p></body></html>"))
        self.label_Q.setText(_translate("Transmit", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600;\">&rho;</span></p></body></html>"))
        self.pushButton_confirm.setText(_translate("Transmit", "Show"))
        self.pushButton_transmit.setText(_translate("Transmit", "Transmit"))
        self.label_click_pos.setText(_translate("Transmit", "Clicked position = (x,y)"))
        self.label_norm_pos.setText(_translate("Transmit", "Norm position = (x, y)"))
        self.label_real_pos.setText(_translate("Transmit", "Real position = (x, y)"))
        self.label_original.setText(_translate("Transmit", "<html><head/><body><p align=\"center\">Original</p></body></html>"))
        self.label_output.setText(_translate("Transmit", "<html><head/><body><p align=\"center\">Output</p></body></html>"))
        self.label_text_original.setText(_translate("Transmit", "<html><head/><body><p align=\"center\">Original</p></body></html>"))
        self.label_text_DCT.setText(_translate("Transmit", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">DCT</span></p></body></html>"))
        self.label_text_zigzag.setText(_translate("Transmit", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Output</span></p></body></html>"))
